    ...
    <form id="registerform" action="${url}/member/registersuccess" method="post">
	   <fieldset class="userinfors baseinfos">
           ...
           <ul>
               ...
               <p>请再次输入密码</p></li>
               <li><label><em>*</em>验证码：</label><input type="text" name="securitycode" class="inputname validate[required] text-input" /><img id="createCheckCode" src="${url}/servlet/SecurityCodeServlet?width=90&height=50" />
